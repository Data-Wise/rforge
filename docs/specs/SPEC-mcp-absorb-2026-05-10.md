...
> **Related:** [Path A in CHANGELOG v1.2.0](https://github.com/Data-Wise/rforge/blob/main/CHANGELOG.md), [rforge-mcp repo](https://github.com/data-wise/rforge-mcp). ORCHESTRATE files for each phase were deleted at merge time per the CLAUDE.md cleanup rule — see PR #3 (B.1) and PR #4 (B.2+B.3+B.4) for the as-shipped commits.
